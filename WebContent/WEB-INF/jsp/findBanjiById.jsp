	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10">
				 	<div class="list-group">
						<a  class="list-group-item active ">修改班级信息</a>
					</div>
				
					<form class="form-horizontal"action="${ctx }/banji?method=updateBanji" method="post">
					  <div class="form-group" >
					   		<label  class="col-sm-2 control-label">班级编号</label>
					   	<div class="col-sm-10">
					   		<input type="text" name="id" value="${banji.id }" class="form-control"/>
					   		<br>
					   	</div>
